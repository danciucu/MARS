...
import tab1, tab2, tab3, globalvars
...
class MARS(ttkthemes.ThemedTk):
    def __init__(self):
        ...
        self.multiple_archs_button = tkinter.ttk.Button(self, text = "MARS Multiple Arches", command = self.multiple_arches)
    ...
    def single_arch(self):
        ...
        globalvars.menu_singlearch += 1

        print(globalvars.menu_singlearch)

        if globalvars.menu_singlearch == 1:
